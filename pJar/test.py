...
# Import CSV
countrypath = ['./loadfiles/greece.csv', './loadfiles/usa.csv', './loadfiles/fra.csv', './loadfiles/italia.csv', './loadfiles/arg.csv', './loadfiles/china.csv', './loadfiles/canada.csv', './loadfiles/japan.csv', './loadfiles/canada.csv', './loadfiles/uk.csv']
data = []
df = []
...
conn = mysql.connector.connect(host='localhost',user=usr,passwd=pwd)
cursor = conn.cursor()
cursor.execute('DROP SCHEMA IF EXISTS countriesdata')
cursor.execute('CREATE SCHEMA `countriesdata` ')
conn = mysql.connector.connect(host='localhost',user=usr ,passwd=pwd ,database="countriesdata")
cursor = conn.cursor()
